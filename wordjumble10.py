...
def wordjumble():
    ...
    def play():
        pygame.mixer.music.load(r"C:\Users\wafa\Downloads\resources\audio\moonlight.wav")
        pygame.mixer.music.play(loops=0)
    b=Button(u,text="playsong",command=play)
    b.pack(pady=10)
    
    bg=PhotoImage(file=r"C:\Users\wafa\Downloads\resources\images\New folder\o7.png")

    c=Canvas(u,width=800,height=500)

    c.pack(fill='both',expand=True)
    c.create_image(0,0,image=bg,anchor='nw')
    c.create_text(650,170,text='Select Level',font=('helvetica',50),fill='black')
